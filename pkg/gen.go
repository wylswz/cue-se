...
const pkgParent = "github.com/wylswz/cue-se/pkg"
...
func (g *generator) goKind(typ types.Type) string {
	...
	case "math/big.Rat":
		return "bigRat"
	case "github.com/wylswz/cue-se/internal/core/adt.Bottom":
		return "error"
	case "github.com/cockroachdb/apd/v3.Decimal":
		return "decimal"
	case "github.com/wylswz/cue-se/internal/pkg.List":
		return "cueList"
	case "github.com/wylswz/cue-se/internal/pkg.Struct":
		return "struct"
	case "[]*github.com/cockroachdb/apd/v3.Decimal":
		return "decimalList"
	case "github.com/wylswz/cue-se/cue.Value":
		return "value"
	case "github.com/wylswz/cue-se/cue.List":
		return "list"
	case "[]string":
		return "stringList"
	case "[]byte":
